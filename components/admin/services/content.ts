/**
 * Service module for managing content (URLs and documents) in the admin interface.
 * Provides interfaces and functions for handling content items and vector data.
 * 
 * @module admin/services/content
 */
